# Awesome Community-Curated NLP List with stars
...
* Speech Synthesis (Text-to-Speech)
  ...
  * [Covarep](https://github.com/covarep/covarep) ⭐ 384 | 🐛 13 | 🌐 MATLAB | 📅 2020-07-27
...
* [NLTK](https://github.com/nltk/nltk) ⭐ 14,724 | 🐛 258 | 🌐 Python | 📅 2026-09-23
...
* Persian
  * [Hazm](https://github.com/sobhe/hazm) ⭐ 1,426 | 🐛 8 | 🌐 Python | 📅 2026-04-01: Python library for digesting Persian text.
...
* Stemming
  * [SerbianStemmer](https://github.com/nikolamilosevic86/SerbianStemmer) ⭐ 18 | 🐛 2 | 🌐 Python | 📅 2020-09-06
  * [Snowball Stemmers](http://snowball.tartarus.org)
  * [Whoosh Stemmers](https://bitbucket.org/mchaput/whoosh/wiki/Home)

* Tokenizers
  * [Toktok](https://github.com/jonsafari/tok-tok) ⭐ 29 | 🐛 1 | 🌐 Python | 📅 2017-05-24: A fast, simple, multilingual tokenizer
...
* Combinatory Categorial Grammar (CCG)
  * [CCG2PST](https://github.com/jkkummerfeld/berkeley-ccg2pst) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2023-06-27 : A tool for converting CCG derivations into PTB-style phrase structure trees
...
* [Affective Tweets](http://github.com/felipebravom/AffectiveTweets) ⭐ 82 | 🐛 0 | 🌐 Java | 📅 2025-06-06
* [PyTweet](https://github.com/Reflejo/pytweet) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2012-07-13
* [Twitter4J](http://twitter4j.org/en/)

# Task Specific

* Entity Linking / Relation Extraction
  * [KNEWS](https://github.com/valeriobasile/learningbyreading) ⭐ 86 | 🐛 14 | 🌐 C | 📅 2022-12-08: Knowledge Extraction With Semantics
  * [Deep Dive](http://deepdive.stanford.edu/relation_extraction): Relation Extraction

* Coreference
  * [Berkley Coreference Error Analyser](https://github.com/jkkummerfeld/berkeley-coreference-analyser) ⭐ 29 | 🐛 0 | 🌐 Python | 📅 2023-06-27 - A tool for classifying errors in coreference resolution

* Parsing
  * [Berkley Parse Error Analyser](https://github.com/jkkummerfeld/berkeley-parser-analyser) ⭐ 40 | 🐛 4 | 🌐 Python | 📅 2023-06-27: A tool for classifying mistakes in the output of parsers

# Machine Translation

* Neural MT
  * [Google Seq2Seq](https://github.com/google/seq2seq) ⚠️ Archived
  * [Amunmt](https://github.com/amunmt/amunmt) ⭐ 1,473 | 🐛 97 | 🌐 C++ | 📅 2023-08-25
  * [Eske Seq2seq](https://github.com/eske/seq2seq) ⭐ 387 | 🐛 6 | 🌐 Python | 📅 2019-05-09
...
* MT List of lists
  * @jonsafari [A list of Neural MT implementations](https://github.com/jonsafari/nmt-list) ⭐ 364 | 🐛 3 | 📅 2022-07-27
...
* Yandex [Fast-RNNLM](https://github.com/yandex/faster-rnnlm) ⭐ 562 | 🐛 33 | 🌐 C++ | 📅 2022-04-26

# Annotation Related

* Annotation Platforms
  * [FLAT](https://github.com/proycon/flat/) ⭐ 113 | 🐛 37 | 🌐 JavaScript | 📅 2025-01-24: FoLiA Linguistic Annotation Tool
...
* Author Attribution
  * [Java Graphical Authorship Attribution Program](https://github.com/evllabs/JGAAP) ⭐ 286 | 🐛 30 | 🌐 Java | 📅 2026-03-18

* Orthography
  * [Gecco](https://github.com/proycon/gecco) ⭐ 24 | 🐛 5 | 🌐 Python | 📅 2022-09-07: Generic Environment for Context-Aware Correction of Orthography
  * [Charguana](https://github.com/alvations/charguana) ⭐ 10 | 🐛 2 | 🌐 Python | 📅 2026-04-17: Character Vomitting for CJK Unicode

* NLP API / Workflow
  * [LuigiNLP](https://github.com/languagemachines/luiginlp) ⭐ 21 | 🐛 1 | 🌐 Python | 📅 2019-10-17: Experimental NLP Pipeline system built on top of SciLuigi
...
* [Awesome NLP](https://github.com/keon/awesome-nlp) ⭐ 19,030 | 🐛 20 | 📅 2026-09-07 (The original one, curated by @keon and @outpark)
...
* @niderhoff [NLP Datasets](https://github.com/niderhoff/nlp-datasets) ⭐ 6,000 | 🐛 12 | 📅 2023-02-15
